...
public class CorreoClientes {
    ...
    public CorreoClientes(String usuarioCorreo, String password, String rutaArchivo, String nombreArchivo, String asunto){
    ...
    //Constructor para la confirmacion de llegada al banco
    public boolean sendMail(String cliente, String destinatario, String Fecha, String Hora){
        ...
        try
        {
            ...
            texto.setText( "Estimado cliente "+cliente+" este es un correo de confirmacion de su llegada al banco el "//Mensaje por defecto para la confirmacion de la llegada del cliente
            + Fecha + " a las " + Hora);
